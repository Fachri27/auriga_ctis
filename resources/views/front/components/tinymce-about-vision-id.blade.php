<div x-show="lang === 'id'" x-data="{
    about_vision_id: @entangle('vision_id'),
    initEditor() {
        let self = this;
        if (tinymce.get('about_vision_editor_id')) tinymce.get('about_vision_editor_id').remove();
        tinymce.init({
            target: this.$refs.about_vision_editor_id,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.about_vision_id || '');
                });
                editor.on('change keyup', () => {
                    self.about_vision_id = editor.getContent();
                });
                    ...
                    onAction: function() {
                        editor.insertContent(`
                                    <figure class='media-caption'>
                                        ...
                                        <figcaption class='media-caption-text'>Caption gambar</figcaption>
                                    </figure>
                                            `);
                    }
                });
    ...
    <label class="block font-medium mb-1">Vision (ID)</label>
    <textarea x-ref="about_vision_editor_id" id="about_vision_editor_id"></textarea>
</div>
