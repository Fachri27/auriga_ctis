<div x-show="lang === 'en'" x-data="{
                    perkembangan_en: @entangle('perkembangan_en'),
                    initEditor() {
                        let self = this;
                        if (tinymce.get('perkembangan_editor_en')) tinymce.get('perkembangan_editor_en').remove();
                        tinymce.init({
                            target: this.$refs.perkembangan_editor_en,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.perkembangan_en || '');
                                });
                                editor.on('change keyup', () => {
                                    self.perkembangan_en = editor.getContent();
                                });
    ...
    <label class="block font-medium mb-1">Perkembangan (EN)</label>
    <textarea x-ref="perkembangan_editor_en" id="perkembangan_editor_en"></textarea>
</div>