<div x-show="lang === 'en'" x-data="{
    about_content_en: @entangle('content_en'),
    initEditor() {
        let self = this;
        if (tinymce.get('about_editor_en')) tinymce.get('about_editor_en').remove();
        tinymce.init({
            target: this.$refs.about_editor_en,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.about_content_en || '');
                });
                editor.on('change keyup', () => {
                    self.about_content_en = editor.getContent();
                });
    ...
    <textarea x-ref="about_editor_en" id="about_editor_en"></textarea>
</div>
