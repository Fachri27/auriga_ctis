<div x-show="lang === 'en'" x-data="{
    permasalahan_en: @entangle('permasalahan_en'),
    initEditor() {
        let self = this;
        if (tinymce.get('permasalahan_editor_en')) tinymce.get('permasalahan_editor_en').remove();
        tinymce.init({
            target: this.$refs.permasalahan_editor_en,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.permasalahan_en || '');
                });
                editor.on('change keyup', () => {
                    self.permasalahan_en = editor.getContent();
                });
    ...
    <textarea x-ref="permasalahan_editor_en" id="permasalahan_editor_en"></textarea>
</div>
