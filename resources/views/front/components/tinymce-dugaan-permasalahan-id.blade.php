<div x-show="lang === 'id'" x-data="{
                    dugaan_permasalahan_id: @entangle('dugaan_permasalahan_id'),
                    initEditor() {
                        let self = this;
                        if (tinymce.get('dugaan_permasalahan_editor_id')) tinymce.get('dugaan_permasalahan_editor_id').remove();
                        tinymce.init({
                            target: this.$refs.dugaan_permasalahan_editor_id,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.dugaan_permasalahan_id || '');
                                });
                                editor.on('change keyup', () => {
                                    self.dugaan_permasalahan_id = editor.getContent();
                                });
    ...
    <textarea x-ref="dugaan_permasalahan_editor_id" id="dugaan_permasalahan_editor_id"></textarea>
</div>
