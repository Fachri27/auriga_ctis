<div x-show="lang === 'id'" x-data="{
                    perkembangan_id: @entangle('perkembangan_id'),
                    initEditor() {
                        let self = this;
                        if (tinymce.get('perkembangan_editor_id')) tinymce.get('perkembangan_editor_id').remove();
                        tinymce.init({
                            target: this.$refs.perkembangan_editor_id,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.perkembangan_id || '');
                                });
                                editor.on('change keyup', () => {
                                    self.perkembangan_id = editor.getContent();
                                });
    ...
    <label class="block font-medium mb-1">Perkembangan Kasus (ID)</label>
    <textarea x-ref="perkembangan_editor_id" id="perkembangan_editor_id"></textarea>
</div>
