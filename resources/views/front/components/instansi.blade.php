<div x-show="lang === 'id'" x-data="{
    instansi: @entangle('instansi'),
    initEditor() {
        let self = this;
        if (tinymce.get('instansi_editor')) tinymce.get('instansi_editor').remove();
        tinymce.init({
            target: this.$refs.instansi_editor,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.instansi || '');
                });
                editor.on('change keyup', () => {
                    self.instansi = editor.getContent();
                });
    ...
    <textarea x-ref="instansi_editor" id="instansi_editor"></textarea>
</div>
