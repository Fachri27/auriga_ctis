<div x-show="lang === 'id'" x-data="{
    about_mission_id: @entangle('mission_id'),
    initEditor() {
        let self = this;
        if (tinymce.get('about_mission_editor_id')) tinymce.get('about_mission_editor_id').remove();
        tinymce.init({
            target: this.$refs.about_mission_editor_id,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.about_mission_id || '');
                });
                editor.on('change keyup', () => {
                    self.about_mission_id = editor.getContent();
                });
    ...
    <textarea x-ref="about_mission_editor_id" id="about_mission_editor_id"></textarea>
</div>
