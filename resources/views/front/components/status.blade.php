<div x-show="lang === 'id'" x-data="{
                    ...
                    initEditor() {
                        let self = this;
                        if (tinymce.get('status_editor')) tinymce.get('status_editor').remove();
                        tinymce.init({
                            target: this.$refs.status_editor,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.status || '');
                                });
                                editor.on('change keyup', () => {
                                    self.status = editor.getContent();
                                });
    ...
    <textarea x-ref="status_editor" id="status_editor"></textarea>
</div>
