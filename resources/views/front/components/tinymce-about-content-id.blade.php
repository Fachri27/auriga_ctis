<div x-show="lang === 'id'" x-data="{
    about_content_id: @entangle('content_id'),
    initEditor() {
        let self = this;
        if (tinymce.get('about_editor_id')) tinymce.get('about_editor_id').remove();
        tinymce.init({
            target: this.$refs.about_editor_id,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.about_content_id || '');
                });
                editor.on('change keyup', () => {
                    self.about_content_id = editor.getContent();
                });
    ...
    <textarea x-ref="about_editor_id" id="about_editor_id"></textarea>
</div>
