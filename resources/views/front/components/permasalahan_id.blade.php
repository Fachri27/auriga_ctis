<div x-show="lang === 'id'" x-data="{
    permasalahan_id: @entangle('permasalahan_id'),
    initEditor() {
        let self = this;
        if (tinymce.get('permasalahan_editor_id')) tinymce.get('permasalahan_editor_id').remove();
        tinymce.init({
            target: this.$refs.permasalahan_editor_id,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.permasalahan_id || '');
                });
                editor.on('change keyup', () => {
                    self.permasalahan_id = editor.getContent();
                });
    ...
    <textarea x-ref="permasalahan_editor_id" id="permasalahan_editor_id"></textarea>
</div>
