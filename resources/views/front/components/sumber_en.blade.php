<div x-show="lang === 'en'" x-data="{
                    sumber_en: @entangle('sumber_en'),
                    initEditor() {
                        let self = this;
                        if (tinymce.get('sumber_editor_en')) tinymce.get('sumber_editor_en').remove();
                        tinymce.init({
                            target: this.$refs.sumber_editor_en,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.sumber_en || '');
                                });
                                editor.on('change keyup', () => {
                                    self.sumber_en = editor.getContent();
                                });
                            },
                        });
                    }
                }" x-init="initEditor" wire:ignore>
    <textarea x-ref="sumber_editor_en" id="sumber_editor_en"></textarea>
</div>