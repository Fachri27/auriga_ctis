<div x-show="lang === 'id'" x-data="{
                    pembelajaran_id: @entangle('pembelajaran_id'),
                    initEditor() {
                        let self = this;
                        if (tinymce.get('pembelajaran_editor_id')) tinymce.get('pembelajaran_editor_id').remove();
                        tinymce.init({
                            target: this.$refs.pembelajaran_editor_id,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.pembelajaran_id || '');
                                });
                                editor.on('change keyup', () => {
                                    self.pembelajaran_id = editor.getContent();
                                });
