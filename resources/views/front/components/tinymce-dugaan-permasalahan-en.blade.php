<div x-show="lang === 'en'" x-data="{
                    dugaan_permasalahan_en: @entangle('dugaan_permasalahan_en'),
                    initEditor() {
                        let self = this;
                        if (tinymce.get('dugaan_permasalahan_editor_en')) tinymce.get('dugaan_permasalahan_editor_en').remove();
                        tinymce.init({
                            target: this.$refs.dugaan_permasalahan_editor_en,
                            ...
                            setup(editor) {
                                editor.on('init', () => {
                                    editor.setContent(self.dugaan_permasalahan_en || '');
                                });
                                editor.on('change keyup', () => {
                                    self.dugaan_permasalahan_en = editor.getContent();
                                });
    ...
    <textarea x-ref="dugaan_permasalahan_editor_en" id="dugaan_permasalahan_editor_en"></textarea>
</div>