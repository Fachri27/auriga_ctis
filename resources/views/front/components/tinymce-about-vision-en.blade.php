<div x-show="lang === 'en'" x-data="{
    about_vision_en: @entangle('vision_en'),
    initEditor() {
        let self = this;
        if (tinymce.get('about_vision_editor_en')) tinymce.get('about_vision_editor_en').remove();
        tinymce.init({
            target: this.$refs.about_vision_editor_en,
            ...
            setup(editor) {
                editor.on('init', () => {
                    editor.setContent(self.about_vision_en || '');
                });
                editor.on('change keyup', () => {
                    self.about_vision_en = editor.getContent();
                });
    ...
    <label class="block font-medium mb-1">Vision (EN)</label>
    <textarea x-ref="about_vision_editor_en" id="about_vision_editor_en"></textarea>
</div>
