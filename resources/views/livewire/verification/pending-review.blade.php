<div class="max-w-7xl mx-auto px-6 py-6 space-y-4 cms-rise">
    <div class="flex items-center justify-between border-b border-[color:var(--hairline)] pb-3">
        <div>
            ...
            <h1 class="text-xl font-semibold text-[color:var(--ink)] tracking-tight mt-0.5">Pending Review</h1>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="cms-table w-full text-sm">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td class="py-12 text-center text-sm text-[color:var(--muted)]" colspan="5">No cases pending review.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
