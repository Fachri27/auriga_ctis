<div class="mb-4 flex flex-col md:flex-row gap-3 items-end">
    ...
    <div class="flex flex-col w-full md:w-1/4">
        ...
        <select wire:model="sector" wire:change="applyFilter" class="px-3 py-2 rounded bg-white/10 border border-white/20">
    ...
    <div class="flex items-center gap-2">
        <button wire:click="applyFilter" class="px-4 py-2 bg-blue-600 text-white rounded">Apply</button>
