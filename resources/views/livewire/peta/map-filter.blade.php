<div class="mb-4 flex flex-col md:flex-row gap-3 items-end">
    <div class="flex flex-col w-full md:w-1/4">
        <label class="text-xs text-white mb-1">{{ __('messages.search') }}</label>
    ...
    <div class="flex flex-col w-full md:w-1/4">
        <label class="text-xs text-white mb-1">{{ __('messages.sector') }}</label>
    ...
    <div class="flex items-center gap-2">
        <button wire:click="applyFilter" class="px-4 py-2 bg-[#122211] text-white rounded">{{ __('messages.apply') }}</button>
