...
<div class="bg-gray-50 mt-20">
    ...
    <section class="max-w-7xl mx-auto px-6 py-10">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 text-sm text-gray-600">
                ...
                {{ $location['district'] ?? 'Lokasi tidak diketahui' }} -
                {{ $location['village'] ?? 'Lokasi tidak diketahui' }}
            </div>
        </div>
    </section>
    ...
    <section class="max-w-6xl mx-auto px-6">
        ...
        ['Desa/Kelurahan', $location['village'] ?? 'Lokasi tidak diketahui'],
        ];
        @endphp
    ...
    {{-- DESKRIPSI + TIMELINE + ARTIKEL --}}
    <section class="max-w-7xl mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">

            {{-- KIRI: Kronologi + Perkembangan --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="pl-3">
                            <h3 class="text-lg font-bold mb-1">
                                <a href="">{{ $artikelTrans?->title ?? '' }}</a>
                            </h3>
                            <p class="text-sm text-gray-600">
                                {!! $artikelTrans?->excerpt ?? '' !!}
                            </p>
                        </div>
                    </div>
                    @empty
