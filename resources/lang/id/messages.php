...
return [
    'about' => "Tentang",
    'report_case' => "Laporkan Kasus",
    'verified_cases' => "Kasus Terverifikasi",
    'login' => "Masuk",
    'register' => "Daftar",
    'search' => 'Cari',
    'sector' => 'Sektor',
    'status' => 'Status',
    'apply' => 'Terapkan',
    'public_transparency' => 'Transparansi Publik',
    'transparency' => 'Transparansi &',
    'case_statistics' => 'Statistik Kasus',
    'explore' => 'Jelajahi laporan publik terverifikasi dan pantau perkembangan kasus lingkungan di seluruh Indonesia secara real time.',
    'case_category' => 'Kasus per Kategori',
    'case_status' => 'Kasus per Status',
    'case_trend' => 'Tren Kasus dari Waktu ke Waktu',
